...
public class ChartPlotterPlugin extends Plugin {
	...
	public void onMenuOptionClicked(MenuOptionClicked e) {
		if (e.getMenuAction() != MenuAction.SET_HEADING) return;
		...
		if (loc == null) return;
		int h = ChartPlotterOverlay.mouseHeading(client, top, loc);
		if (h >= 0) course = h;
	}
	@Subscribe
	...
	static boolean isPlayerOnShip(Player player, WorldView topWorldView) {return getPlayerShip(player, topWorldView) != null;}
